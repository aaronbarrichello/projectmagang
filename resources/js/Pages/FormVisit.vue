            ...
            <div class="flex flex-col lg:flex-row w-full">
                ...
                >
                    <div class="flex items-center gap-5">
                        <div class="logo1">
                            <img
                                src="../../img/direktorat-logo.png"
                                class="max-w-[75px] lg:max-w-[100px] inline-block rounded-full ring-2 ring-white bg-white"
                            />
                        </div>
                        <div class="logo2">
                            <img
                                src="../../img/tu-logo.png"
                                class="max-h-[50px] lg:max-h-[75px] bg-white rounded-md"
                            />
                        </div>
                    </div>
                    <div>
                        <span class="text-3xl font-semibold"
                            >Visit Request App</span
                        >
                    </div>
                    <div>
                        <BaseButton
